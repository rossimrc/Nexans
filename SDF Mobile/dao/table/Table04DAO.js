 ...
 * Class Table04DAO
 */
function Table04DAO(database)
{
	this.db = database;
}

Table04DAO.prototype = new Table04Bean();
 ...
 */
Table04DAO.prototype.getByTableName = function(tableName) {
	...
	this.db.transaction(function (transaction) {
	    ...
	    var query="SELECT * FROM TAB_AUXILIAR_04 WHERE " + filtro +";";
	    //alert("Query: " + query);
 ...
 * @return The array Table02Bean
 */
Table04DAO.prototype.getByCorrente = function(tableName, corrente, nomeColuna, numeroCondutores, minimaSecao, maximaSecao) {
 ...
 * @param double secao
 */
Table04DAO.prototype.getBySecao = function(tableName, secao) {
 ...
 */
Table04DAO.prototype.getByMaiorSecao = function(tableName, secaoMinima) {
